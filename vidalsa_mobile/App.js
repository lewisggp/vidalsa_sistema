...
function PantallaEquipos({ user, onOpenMenu }) {
  ...
  const cargar = useCallback(async () => {
    ...
    try {
      ...
      if (advAnio) data = data.filter(e => String(e.anio || '') === String(advAnio));
  ...
  }, [busqueda, filtroFrente, filtroTipo, filtroEstado, advModelo, advMarca, advAnio, advCategoria, advEstadoOp, chkPropiedad, chkPoliza, chkRotc, chkRacda]);
      ...
      <View style={{ paddingHorizontal: 12, paddingTop: 8, paddingBottom: 10, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#f1f5f9', gap: 8 }}>
        ...
        <View style={{ flexDirection: 'row', gap: 8 }}>
          ...
          <View style={{ position: 'relative', zIndex: 100 }}>
            ...
            >
              <MaterialIcons name="filter-list" size={22} color={advancedFiltersVisible ? '#0067b1' : '#64748b'} />
            </TouchableOpacity>

            {/* Panel flotante de Filtros Avanzados */}
            {advancedFiltersVisible && (
              <View style={{ position: 'absolute', top: 52, right: 0, width: 300, backgroundColor: '#e2e8f0', borderRadius: 12, padding: 15, zIndex: 200, elevation: 10, shadowColor: '#000', shadowOpacity: 0.15, shadowRadius: 10, shadowOffset: { height: 5, width: 0 } }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 15 }}>
                  <Text style={{ fontSize: 14, fontWeight: '700', color: '#334155' }}>Filtros Avanzados</Text>
                  <TouchableOpacity onPress={clearAdvancedFilters}>
                    <Text style={{ fontSize: 11, color: '#64748b', textDecorationLine: 'underline' }}>Limpiar Todo</Text>
                  </TouchableOpacity>
                </View>

                {/* Modelo */}
                <View style={{ marginBottom: 12 }}>
                  <Text style={{ fontSize: 12, fontWeight: '600', color: '#64748b', marginBottom: 4 }}>Modelo</Text>
                  <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 6, borderWidth: 1, borderColor: '#e2e8f0', paddingHorizontal: 8, height: 32 }}>
                    <MaterialIcons name="search" size={16} color="#94a3b8" />
                    <TextInput style={{ flex: 1, fontSize: 12, color: '#1e293b', paddingVertical: 0, marginLeft: 4 }} placeholder="Escribir modelo..." placeholderTextColor="#94a3b8" value={advModelo} onChangeText={setAdvModelo} />
                  </View>
                </View>

                {/* Marca */}
                <View style={{ marginBottom: 12 }}>
                  <Text style={{ fontSize: 12, fontWeight: '600', color: '#64748b', marginBottom: 4 }}>Marca</Text>
                  <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 6, borderWidth: 1, borderColor: '#e2e8f0', paddingHorizontal: 8, height: 32 }}>
                    <MaterialIcons name="search" size={16} color="#94a3b8" />
                    <TextInput style={{ flex: 1, fontSize: 12, color: '#1e293b', paddingVertical: 0, marginLeft: 4 }} placeholder="Escribir marca..." placeholderTextColor="#94a3b8" value={advMarca} onChangeText={setAdvMarca} />
                  </View>
                </View>

                {/* Año */}
                <View style={{ marginBottom: 12 }}>
                  <Text style={{ fontSize: 12, fontWeight: '600', color: '#64748b', marginBottom: 4 }}>Año</Text>
                  <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 6, borderWidth: 1, borderColor: '#e2e8f0', paddingHorizontal: 8, height: 32 }}>
                    <MaterialIcons name="search" size={16} color="#94a3b8" />
                    <TextInput keyboardType="numeric" style={{ flex: 1, fontSize: 12, color: '#1e293b', paddingVertical: 0, marginLeft: 4 }} placeholder="Escribir año..." placeholderTextColor="#94a3b8" value={advAnio} onChangeText={setAdvAnio} />
                  </View>
                </View>

                {/* Categoria Flota */}
                <View style={{ marginBottom: 12 }}>
                  <Text style={{ fontSize: 12, fontWeight: '600', color: '#64748b', marginBottom: 4 }}>Categoría Flota</Text>
                  <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 6, borderWidth: 1, borderColor: '#e2e8f0', paddingHorizontal: 8, height: 32 }}>
                    <MaterialIcons name="local-shipping" size={16} color="#94a3b8" />
                    <TextInput style={{ flex: 1, fontSize: 12, color: '#1e293b', paddingVertical: 0, marginLeft: 4 }} placeholder="FLOTA LIVIANA / PESADA" placeholderTextColor="#94a3b8" value={advCategoria} onChangeText={setAdvCategoria} />
                  </View>
                </View>

                {/* Estado Operativo */}
                <View style={{ marginBottom: 12 }}>
                  <Text style={{ fontSize: 12, fontWeight: '600', color: '#64748b', marginBottom: 4 }}>Estado Operativo</Text>
                  <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 6, borderWidth: 1, borderColor: '#e2e8f0', paddingHorizontal: 8, height: 32 }}>
                    <MaterialIcons name="info" size={16} color="#94a3b8" />
                    <TextInput style={{ flex: 1, fontSize: 12, color: '#1e293b', paddingVertical: 0, marginLeft: 4 }} placeholder="OPERATIVO / INOPERATIVO..." placeholderTextColor="#94a3b8" value={advEstadoOp} onChangeText={setAdvEstadoOp} />
                  </View>
                </View>

                {/* Documentación (Checkboxes SIMULADOS) */}
                <View style={{ borderTopWidth: 1, borderTopColor: '#cbd5e1', paddingTop: 10, marginTop: 5 }}>
                  <Text style={{ fontSize: 12, fontWeight: '600', color: '#64748b', marginBottom: 8 }}>Documentación Cargada</Text>
                  <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 10 }}>
                    <TouchableOpacity onPress={() => setChkPropiedad(!chkPropiedad)} style={{ flexDirection: 'row', alignItems: 'center', width: '45%', marginBottom: 6 }}>
                      <MaterialIcons name={chkPropiedad ? "check-box" : "check-box-outline-blank"} size={18} color={chkPropiedad ? "#0067b1" : "#94a3b8"} style={{ marginRight: 6 }} />
                      <Text style={{ fontSize: 12, color: '#334155' }}>Propiedad</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => setChkPoliza(!chkPoliza)} style={{ flexDirection: 'row', alignItems: 'center', width: '45%', marginBottom: 6 }}>
                      <MaterialIcons name={chkPoliza ? "check-box" : "check-box-outline-blank"} size={18} color={chkPoliza ? "#0067b1" : "#94a3b8"} style={{ marginRight: 6 }} />
                      <Text style={{ fontSize: 12, color: '#334155' }}>Póliza</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => setChkRotc(!chkRotc)} style={{ flexDirection: 'row', alignItems: 'center', width: '45%', marginBottom: 6 }}>
                      <MaterialIcons name={chkRotc ? "check-box" : "check-box-outline-blank"} size={18} color={chkRotc ? "#0067b1" : "#94a3b8"} style={{ marginRight: 6 }} />
                      <Text style={{ fontSize: 12, color: '#334155' }}>ROTC</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => setChkRacda(!chkRacda)} style={{ flexDirection: 'row', alignItems: 'center', width: '45%', marginBottom: 6 }}>
                      <MaterialIcons name={chkRacda ? "check-box" : "check-box-outline-blank"} size={18} color={chkRacda ? "#0067b1" : "#94a3b8"} style={{ marginRight: 6 }} />
                      <Text style={{ fontSize: 12, color: '#334155' }}>RACDA</Text>
                    </TouchableOpacity>
                  </View>
                </View>
