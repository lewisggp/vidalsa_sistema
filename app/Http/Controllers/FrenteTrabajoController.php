...
class FrenteTrabajoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->merge([
            ...
            'RESP_1_CED'    => mb_strtoupper($request->input('RESP_1_CED', '')),
            ...
            'RESP_2_CED'    => mb_strtoupper($request->input('RESP_2_CED', '')),
            ...
            'RESP_3_CED'    => mb_strtoupper($request->input('RESP_3_CED', '')),
            ...
            'RESP_4_CED'    => mb_strtoupper($request->input('RESP_4_CED', '')),
